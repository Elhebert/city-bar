...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?php echo $this->webroot; ?>chope%20pm.png">
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li <?= ($this->params->controller == 'home' && $this->params->action == 'index') ? 'class="active"' : '' ?>><?= $this->Html->link('Accueil', array('admin' => false, 'controller' => 'home', 'action' => 'index')); ?></li>
                        ...
                        <?php if ($this->Session->read('Auth.User.role') == 2): ?>
                            <li <?= ($this->params->controller == 'users' && $this->params->action == 'index') ? 'class="active"' : '' ?>><?= $this->Html->link('Panel Admin', array('admin' => true, 'controller' => 'users', 'action' => 'index')); ?></li>
                        <?php endif ?>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <?= $this->Form->create('bars', array('action' => 'search', 'class' => 'navbar-form navbar-left hidden-xs')); ?>
                        ...
                        <li <?= ($this->params->controller == 'users' && $this->params->action != 'index') ? 'class="active"' : '' ?>>
                            <?php if (!$this->Session->read('Auth.User.id')): ?>
                                <a href="<?= $this->Html->url(array('admin' => false, 'controller' => 'users', 'action' => 'login')); ?>"><span class="glyphicon glyphicon-user"></span></a>
                            <?php else: ?>
                                <a href="<?= $this->Html->url(array('admin' => false, 'controller' => 'users', 'action' => 'edit')); ?>"><span class="glyphicon glyphicon-user"></span></a>
                            <?php endif ?>
        ...
        <footer class="panel-footer">
            <div class="text-center">
                <a href="https://facebook.com/citybar.be" target="_blank"><?= $this->Html->image('fb_small.png'); ?></a><a href="https://twitter.com/citybar_be" target="_blank"><?= $this->Html->image('twitter_small.png'); ?></a><a href="plus.google.com/101381680898227406612"><?= $this->Html->image('gp_small.png'); ?></a>
